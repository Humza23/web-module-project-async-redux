    ...
    return (
        <div>
            <h1 style={{fontSize: '3rem'}}>
                ...
                <br></br>
                My favorite team is the: {props.teamInfo.name} <img style={{width: "2%", height: '5.5vh', borderRadius: '50%', verticalAlign: 'middle'}}src='http://www.screensaversplanet.com/img/screenshots/screensavers/nba-leatherback-logos-1.png'/>
            </h1>
            <div>
